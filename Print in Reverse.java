...
class Result {
    ...
    public static void reversePrint(SinglyLinkedListNode llist, SinglyLinkedListNode current, Stack<Integer> s)
    {
        if (current == null)
        {
            empty(s);
        ...
        s.push(current.data);
        reversePrint(llist, current.next, s);
    }
    public static void reversePrint(SinglyLinkedListNode llist) {
    // Write your code here
        Stack<Integer> s = new Stack<>();
        SinglyLinkedListNode current = llist;
        reversePrint(llist,current,s);
    }
