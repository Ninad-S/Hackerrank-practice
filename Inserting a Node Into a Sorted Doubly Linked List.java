...
class Result {
     ...
     *
     */
    public static DoublyLinkedListNode sortedInsert(DoublyLinkedListNode llist, int data,DoublyLinkedListNode current ) {
    // Write your code here
        ...
        if (data <= llist.data)
        {
            DoublyLinkedListNode newOne = new DoublyLinkedListNode(data);
            newOne.next = llist;
            llist.prev=newOne;
            llist = llist.prev;
            return llist;
        ...
        return sortedInsert(llist,data,current.next);
        
    }
    public static DoublyLinkedListNode sortedInsert(DoublyLinkedListNode llist, int data) {
    // Write your code here
        DoublyLinkedListNode current = llist;
        return sortedInsert(llist,data,current);
    }
